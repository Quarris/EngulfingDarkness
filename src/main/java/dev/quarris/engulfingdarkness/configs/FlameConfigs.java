...
public class FlameConfigs {
    ...
    private static void initializeDefaults() {
        ...
        DEFAULT_LIGHTBRINGERS.put("lava_bucket", new LightBringer(Items.LAVA_BUCKET, 64000, 40, 2.0f, 100.0f, Lists.newArrayList(new GiveItem(Items.BUCKET, 1), new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1))/*, new ApplyPotionEffect(EasyTarget)*/));
        ...
        DEFAULT_LIGHTBRINGERS.put("light_gray_candle", new LightBringer(Items.LIGHT_GRAY_CANDLE, 64000, 200, 1.5f, 4.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1)/*, new ApplyPotionEffect(PIERCER, 80, 0, true)*/)));
        ...
        DEFAULT_LIGHTBRINGERS.put("orange_candle", new LightBringer(Items.ORANGE_CANDLE, 64000, 200, 1.5f, 5.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1)/*, new ApplyPotionEffect(RESILIENCE, 80, 1, false)*/)));
        ...
        DEFAULT_LIGHTBRINGERS.put("green_candle", new LightBringer(Items.GREEN_CANDLE, 64000, 200, 1.5f, 4.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new ApplyPotionEffect(MobEffects.LUCK, 2400, 0, false)/*, new ApplyPotionEffect(CASTER, 2400, 0, false)*/)));
