...
public class FlameConfigs {
    ...
    private static void initializeDefaults() {
        ...
        DEFAULT_LIGHTBRINGERS.put("green_candle", new LightBringer(Items.LIME_CANDLE, 64000, 200, 1.5f, 4.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new ApplyPotionEffect(MobEffects.LUCK, 2400, 0, false)/*, new ApplyPotionEffect(CASTER, 2400, 0, false)*/)));
